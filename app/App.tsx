    ...
    const processItem = (item: FileItem, path = "") => {
      if (item.type === "file" && item.download_url) {
        ...
        return fetch(item.url)
          .then((response) => response.json())
          .then((contents) => {
            const subPromises = contents.map((subItem: FileItem) =>
    ...
    <div className="mx-3">
      <div className="container m-0 bg-white min-h-screen max-w-[960px] mx-auto lg:rounded-md rounded-md p-5 lg:mb-5">
        ...
        >
          <div className="relative w-full max-w-full sm:mr-5">
            <input
              ...
              value={urlInput}
              className="w-full mr-auto mb-5 sm:mr-5 p-5 rounded-md border-2 border-blue-950"
              onPaste={handlePaste}
              name="urlInput"
          ...
          >
            ...
            <div>
              <h3 className="mb-2 font-semibold">
                You have entered a GitHub repository URL instead of a folder
                URL!
              </h3>
              <p>
                You will download the entire repository instead of a github
                folder.
              </p>
            </div>
          </div>
        ...
        {error && !loading && (
          ...
          >
            ...
            <div>
              ...
              <p>
                If this repository is private then please make it public for a
                while to download it.{" "}
              </p>
            </div>
          </div>
        )}
                ...
                >
                  ...
                  <div id="content-3a" className="flex-1 overflow-auto">
                    <p>
                      ...
                      website with your friends, that would be a great help.
                    </p>
                    <div className="text-nowrap">
                      <div className="text-[13px] md:text-[16px] bg-[#4267B2] my-3 p-3 rounded text-center">
                        <a
                          href="https://facebook.com/TechHelpBD"
                          target="_blank"
        ...
        {sizeMB ? (
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-center items-center  min-w-full my-10 shadow-md p-8 rounded-lg border-t border-l border-l-[#005eb6] border-t-[#005eb6] border-b-2 border-r-2 border-b-[#0084ff] border-r-[#0084ff]  space-x-5">
              <div className="flex-1">
                ...
                {!warning && (
                  <p
                    onClick={goBack}
                    className="cursor-pointer  text-sm font-semibold my-5 inline-flex p-1 items-center justify-center gap-2 whitespace-nowrap rounded border border-sky-500 text-sky-500 px-6 outline-none bg-transparent active:text-sky-600 transition duration-200 active:scale-90"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                ...
                <p className="text-sky-900 text-xl font-semibold mb-5">
                  Zipped {data?.length} Files
                </p>
                <ul className="space-y-3">
                  {data?.map((item, index) => (
                    <li
                      key={index}
                      className="flex items-center gap-2 text-sm text-sky-900 font-semibold"
                    >
                      {item.type === "file" ? (
                ...
                <h2 className="mt-5 text-xl font-semibold  text-sky-900">
                  Size: {sizeMB}
                </h2>
                ...
                <div className="min-w-full overflow-hidden rounded bg-white text-slate-500">
                  ...
                  <div className="flex justify-end gap-2 p-2 pt-0 mt-2">
                    <button
                      ...
                      className="text-sky-500 inline-flex h-10 items-center justify-center gap-2 justify-self-center whitespace-nowrap rounded px-5 outline-none bg-transparent border-none active:text-blue-500 transition duration-200 active:scale-90"
                    >
                      <span className="relative only:-mx-6">
                        <DownloadIcon />
                      </span>
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-700 text-center m-5">
              Free Online Github Folder Downloader
            </h2>
            <p className="text-left mb-10">
              Are you tired of struggling to download your favorite Github
              Folders? Do you want a fast, reliable, and user-friendly solution
              to enjoy your beloved code offline? <br />
              Look no further! GitDown Github Folder Downloader is here to
              revolutionize your Folder downloading experience. Discover the
              seamless experience with GitDown Github Downloader, enabling you
              to effortlessly download your desired Github Folders in
              high-quality for convenient offline viewing.
            </p>
              ...
              <div className="container px-6 m-auto">
                <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                  <div className="col-span-4">
                    <h2 className="mr-5 sm:mr-20 lg:mr-10  flex flex-col justify-center items-center text-xl font-bold">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        fill="currentColor"
                    ...
                    <h2 className="my-2 text-xl font-bold text-gray-700 text-left">
                      Multiple Format Support
                    </h2>
                    <p className="text-left">
                      GitDown will help you to download both github repository
                      and folders in just one click. <br />
                      What you need to do is just copy the Github repository or
                      folder link and paste it on our input field.
                    </p>
                  </div>
                  <div className=" col-span-4">
                    <h2 className="mr-5 sm:mr-20 lg:mr-10 flex flex-col justify-center items-center text-xl font-bold">
                    ...
                    <h2 className="my-2 text-xl font-bold text-gray-700 text-left">
                      Paste & Download Folders
                    </h2>
                    <p className="text-left">
                      If you paste the Github url on input field then our
                      algorithm will detect the url and automatically convert
                      the files for you. No more hassle for pressing Enter
                      button.
                    </p>
                  </div>
                  <div className="col-span-4">
                    ...
                    <p className="text-left">
                      GitDown is designed for ease of use. Our simple and
                      intuitive interface allows you to download and convert
                      Folders in just a few clicks, without the need for any
                  ...
                  <div className="col-span-4">
                    ...
                    <p className="text-left">
                      Unlike many other Folder downloaders, GitDown is an online
                      tool that doesn't require you to install any software on
                      your device. Simply visit our website, enter the Folder
                      URL, and start downloading your favorite code.
                    </p>
                  </div>
                  <div className="col-span-4">
                    <h2 className="mr-5 sm:mr-20 lg:mr-10 flex flex-col justify-center items-center text-xl font-bold">
                    ...
                    <p className="text-left">
                      We understand that time is precious, so we have optimized
                      our platform to provide you with the fastest download
                      speeds possible. Say goodbye to long waiting times and
                      hello to instant Folder gratification.
                    </p>
                  </div>
                  <div className="col-span-4">
                    <h2 className="mr-5 sm:mr-20 lg:mr-10 flex flex-col justify-center items-center text-xl font-bold">
                    ...
                    <p>
                      GitDown downloads the folder's files from official Github
                      website and then zip them together. Thats why our
                      generated zip files are always safe as Github
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="my-10">
              <h2 className="mb-5 text-center text-gray-700 text-3xl font-bold">
                The Best Github Downloader
              </h2>
              <p className="text-left">
                So, what are you waiting for? Give GitDown Github Folder
                Downloader a try today and experience the ultimate in Folder
                downloading convenience and versatility. We are confident that
            ...
            <section className="mb-10">
              <h2 className="mb-5 text-center text-gray-700 text-3xl font-bold">
                How to Download Github Folders
              </h2>
              <div className="flex justify-center items-center">
                <ul className="list-none flex max-w-[23rem] md:max-w-full flex-col md:flex-row justify-center items-center">
                  <div className="flex max-w-[26rem] flex-1 justify-center items-center">
                    <li className="flex items-start flex-1">
                      <span className="number flex items-center justify-center font-bold text-4xl w-16 h-16 rounded-full bg-blue-200 text-blue-500 mr-2 mb-2">
                        1
                      </span>
                    </li>
                    <li>
                      <span>Simply Enter your desired Github folder link</span>
                    </li>
                  </div>
                  <div className="flex max-w-[26rem] flex-1 justify-center items-center">
                    <li className="flex items-start flex-1">
                      <span className="number flex items-center justify-center font-bold text-4xl w-16 h-16 rounded-full bg-red-200 text-red-500 mr-2 mb-2">
                        2
                      </span>
                    </li>
                    <li>
                      <span>Wait briefly for the zip conversion to finish</span>
                    </li>
                  </div>
                  <div className="flex max-w-[26rem] flex-1 justify-center items-center">
                    <li className="flex items-start flex-1">
                      <span className="number flex items-center justify-center font-bold text-4xl w-16 h-16 rounded-full bg-green-200 text-green-500 mr-2 mb-2">
                        3
                      </span>
                    </li>
                    <li>
                      <span>
                        Then click on download button to save the zip file on
                        your device
                      </span>
                    </li>
                  </div>
            ...
            <h2 className="text-3xl font-bold text-center mb-5 text-gray-700">
            ...
            <section className="w-full divide-y divide-slate-200 rounded border border-slate-200 bg-white">
              <details className="group p-4" open>
                ...
                <p className="mt-4 text-slate-500">
                  Look Github already allowing you to download the repository
                  from their website. You could also download the folder files
                  one by one from Github. But it would cost lots of time and
                  effort. That's why we made this tool to help you to download
                  the folder from Github in just one click.
                  <br /> <br />
                  So, it's completely legal to download the folder from Github
                  using GitDown.
                </p>
              </details>
              <details className="group p-4">
                ...
                <p className="mt-4 text-slate-500">
                  Yes, sometimes you may change your decision to download whole
                  repository instead of a single folder.
                  <br /> In that case, you can simply paste the repository link
                  on the input field and then click on the download button. Our
                  algorithm will detect the repository and then convert the
                  entire repository as a zip file for you.
                  <br />
                  <br />
                  But you may see a warning message. Don't worry, it's just
                  because to let you know that you are downloading the entire
                  repository instead of a folder.
                </p>
              </details>
              <details className="group p-4">
                <summary className="relative cursor-pointer list-none pr-8 font-medium text-slate-700 transition-colors duration-300 focus-visible:outline-none group-hover:text-slate-900  [&::-webkit-details-marker]:hidden">
                ...
                <p className="mt-4 text-slate-500">
                  You can use any kind of zip extractor like{" "}
                  <a
                    className="font-bold"
                  ...
                  to unzip and access the files which are zipped inside the
                  Github folder.
                </p>
              </details>
              <details className="group p-4">
                ...
                <p className="mt-4 text-slate-500">
                  GitDown is considered a safe and clean service, with no
                  viruses and under intense supervision based on a security
                  algorithm. However, always practice caution while using any
                  online tool and ensure you have up-to-date security software
                  on your device.
                </p>
              </details>
            </section>
