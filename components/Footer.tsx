        ...
        <div className="pt-16 pb-12 text-sm border-t border-gray-600 bg-[#3d4451]">
          <div className="container px-6 mx-auto">
            <div className="flex flex-col sm:flex-row justify-around">
              ...
              >
                <Image
                  className="mx-auto h-32 w-32 mb-5"
                  width={100}
                  height={100}
                ...
                <p className="max-w-[26rem]">
                  GitDown is a Github Folder Downloader powered by Tech Help BD!{" "}
                  <br /> <br />
                  We are excited to provide you with a user-friendly online
                  platform to download your code. GitDown can download any
                  github repository or folder. <br />
                  <br />
                  Please feel free to provide any feedback to help us improve
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      href="https://techhelpbd.com/about-us"
                      target="_blank"
              ...
              >
                ...
                <div>
                  <div className="grid grid-flow-col gap-4">
                    <a
                      href="https://facebook.com/groups/TechHelpBangladesh"
                      target="_blank"
                      title="Facebook"
                      rel="noopener noreferrer"
                    >
                    ...
                    <a
                      href="https://t.me/TechHelpBangladesh"
                      target="_blank"
                      title="Telegram"
                      rel="noopener noreferrer"
                    >
                ...
                <a
                  className="px-5"
                  href="https://www.buymeacoffee.com/MahbubDev"
                  target="_blank"
                >
                  <Image
